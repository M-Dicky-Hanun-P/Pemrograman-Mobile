...
import 'landing_page.dart'; // Mengimpor halaman LandingPage dari file lain untuk digunakan sebagai halaman utama aplikasi.
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      title:
          'Bintang MDHP', // Menetapkan judul aplikasi yang ditampilkan di taskbar.
      theme: ThemeData(
          primarySwatch: Colors
              .blue), // Menetapkan tema aplikasi dengan palet warna biru sebagai warna utama.
      home:
          const LandingPage(), // Menetapkan halaman awal aplikasi yang akan ditampilkan, yaitu LandingPage.
    );
  }
}
